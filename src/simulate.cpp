...
ArgSpec arg_list[] = {
    ...
    ArgSpec("n_victims",    's', "10", 1, "Number of anycasted victims"),
    ArgSpec("smart_distr",  'i',  "1", 0, "Distribute anycasted victims hierarchically"),
    ArgSpec("tries",        'i',  "1", 1, "Number of tries when sending anycasted victims to children"),
